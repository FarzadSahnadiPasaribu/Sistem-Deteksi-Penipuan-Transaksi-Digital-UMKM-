...
<div class="mobile-topbar">
  <a href="/campusvents/index.php" class="mobile-topbar-logo">Campus<span class="accent">Vents</span></a>
...
<aside class="sidebar dashboard-sidebar" role="navigation" aria-label="Navigasi utama">
  <div class="sidebar-header">
    <a href="/campusvents/index.php" class="sidebar-logo">
  ...
  <nav class="sidebar-nav">
    <?php if ($role === 'mahasiswa'): ?>
      ...
      <a href="/campusvents/mahasiswa/dashboard.php" class="sidebar-link<?= isActive('dashboard.php','mahasiswa') ?>">
      ...
      <a href="/campusvents/mahasiswa/katalog.php" class="sidebar-link<?= isActive('katalog.php','mahasiswa') ?>">
      ...
      <a href="/campusvents/mahasiswa/my_events.php" class="sidebar-link<?= isActive('my_events.php','mahasiswa') ?>">
      ...
      <a href="/campusvents/mahasiswa/notifikasi.php" class="sidebar-link<?= isActive('notifikasi.php','mahasiswa') ?>">
      ...
      <a href="/campusvents/mahasiswa/profil.php" class="sidebar-link<?= isActive('profil.php','mahasiswa') ?>">
    ...
    <?php elseif ($role === 'panitia'): ?>
      ...
      <a href="/campusvents/panitia/dashboard.php" class="sidebar-link<?= isActive('dashboard.php','panitia') ?>">
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
        Dashboard
      </a>
      <a href="/campusvents/panitia/buat_event.php" class="sidebar-link<?= isActive('buat_event.php','panitia') ?>">
      ...
      <a href="/campusvents/panitia/daftar_event.php" class="sidebar-link<?= isActive('daftar_event.php','panitia') ?>">
      ...
      <a href="/campusvents/panitia/peserta.php" class="sidebar-link<?= isActive('peserta.php','panitia') ?>">
      ...
      <a href="/campusvents/panitia/kehadiran.php" class="sidebar-link<?= isActive('kehadiran.php','panitia') ?>">
    ...
    <?php elseif ($role === 'admin'): ?>
      ...
      <a href="/campusvents/admin/dashboard.php" class="sidebar-link<?= isActive('dashboard.php','admin') ?>">
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
        Dashboard
      </a>
      <a href="/campusvents/admin/validasi_event.php" class="sidebar-link<?= isActive('validasi_event.php','admin') ?>">
      ...
      <a href="/campusvents/admin/kelola_pengguna.php" class="sidebar-link<?= isActive('kelola_pengguna.php','admin') ?>">
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>
        Kelola Pengguna
      </a>
      <a href="/campusvents/admin/kelola_kategori.php" class="sidebar-link<?= isActive('kelola_kategori.php','admin') ?>">
      ...
      <a href="/campusvents/admin/laporan.php" class="sidebar-link<?= isActive('laporan.php','admin') ?>">
    ...
    <a href="/campusvents/logout.php" class="sidebar-link danger"
